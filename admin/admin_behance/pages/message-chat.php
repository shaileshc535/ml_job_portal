                    ...
                    <div class="chat-module">
                        <div class="chat-module-top">
                            ...
                            <div class="chat-module-body">
                                <div class="media chat-item">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="chat-item-body">
                                            <p>Hey guys, Phasellus imperdiet arcu venenatis, malesuada nulla a, porta
                                                sem. Curabitur nec massa ultrices, consequat erat sit amet, luctus
                                                justo. Brand Concept &amp; Design!</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="media chat-item">
                                    <img alt="Komal" src="../assets/images/avatar-2.jpg"
                                        class="rounded-circle user-avatar-lg">
                                    <div class="media-body">
                                        <div class="chat-item-title">
                                        ...
                                        <div class="chat-item-body">
                                            <p>Nice one <a href="#">@Komal</a>, Nulla ut diam porttitor odio malesuada
                                                malesuada eu at ipsum.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="media chat-item">
                                    <img alt="Bhoomi" src="../assets/images/avatar-4.jpg"
                                        class="rounded-circle user-avatar-lg">
                                    <div class="media-body">
                                        <div class="chat-item-title">
                                ...
                                <div class="media chat-item">
                                    <img alt="Kimberly" src="../assets/images/avatar-4.jpg"
                                        class="rounded-circle user-avatar-lg">
                                    <div class="media-body">
                                        <div class="chat-item-title">
                                        ...
                                        <div class="chat-item-body">
                                            <p>Well done <a href="#">@all</a>. See you all Fusce tempus ipsum a mi
                                                rutrum, at dignissim mauris vulputate. 🤜</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <ul class="nav nav-tabs nav-justified" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="files-tab" data-toggle="tab" href="#files"
                                                role="tab" aria-controls="files" aria-selected="false">Files</a>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="tab-content">
                                                    ...
                                                    <a class="list-group-item list-group-item-action" href="#">
                                                        <div class="media media-member mb-0">
                                                            <img alt="Claire Connors"
                                                                src="../assets/images/avatar-1.jpg" class="avatar">
                                                            <div class="media-body ">
                                                    ...
                                                    <a class="list-group-item list-group-item-action" href="#">
                                                        <div class="media media-member mb-0">
                                                            <img alt="Marcus Simmons"
                                                                src="../assets/images/avatar-2.jpg" class="avatar">
                                                            <div class="media-body">
                                                    ...
                                                    <a class="list-group-item list-group-item-action" href="#">
                                                        <div class="media media-member mb-0">
                                                            <img alt="David Whittaker"
                                                                src="../assets/images/avatar-3.jpg" class="avatar">
                                                            <div class="media-body">
                                        ...
                                        <div class="tab-pane fade" id="files" role="tabpanel"
                                            ...
                                            <div id="test-list-2">
                                                            ...
                                                            <ul class="avatars list-unstyled">
                                                                <li>
                                                                    <div
                                                                        ...
                                                                        <img src="https://jituchauhan.com/"
                                                                            class="avatar" data-dz-thumbnail="" alt="">
                                                                        <i class="fas fa-paperclip"></i>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                ...
                                                <ul
                                                    class="list-group list-group-activity dropzone-previews flex-column-reverse list-group-flush list ">
