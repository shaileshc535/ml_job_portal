...
if (isset($_GET['type']) && $_GET['type'] != '') {
    ...
    if ($type == 'delete') {
        ...
        $delete_sql = "delete from ecom_categories where id='$id'";
                                    ...
                                    <table id="category_table" class="table table-bordered table-striped table-hover"
                                        ...
                                        <tbody>
                                            ...
                                            <tr style="text-align:center; font-size:16px; ">
                                                ...
                                                <td>
                                                    <?php
                                                            echo "<span class='badge btn btn-lg btn-success badge-edit'><a href='update_category.php?id=" . $row['id'] . "'>Edit</a></span>&nbsp;";
