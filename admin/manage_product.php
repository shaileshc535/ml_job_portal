...
if (isset($_GET['type']) && $_GET['type'] != '') {
    ...
    if ($type == 'status') {
        ...
        $update_status_sql = "update ecom_product set status='$status' where id='$id'";
        mysqli_query($con, $update_status_sql);
    }

    if ($type == 'delete') {
        $id = get_safe_value($con, $_GET['id']);
        $delete_sql = "delete from ecom_product where id='$id'";
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="section-block" id="basicform">
                                    <h3 class="section-title text-center">All Product Details Section</h3>
                                </div>
                                <div class="card">
                                    <div>
                                                ...
                                                <tr style="text-align:center; font-size:16px; ">
                                                    ...
                                                    <td>
                                                        <?php
                                                                ...
                                                                echo "<span class='badge btn btn-sm btn-success badge-edit'><a href='products.php?id=" . $row['id'] . "'>Edit</a></span>&nbsp;";
