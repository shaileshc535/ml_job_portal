                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="home" role="tabpanel"
                                    ...
                                    <p>Phasellus non ante gravida, ultricies neque a, fermentum leo. Etiam ornare enim
                                        ...
                                        efficitur. Aliquam id congue lorem. Proin consectetur feugiasse platea dictumst.
                                        Pellentesque sed justo aliquet, posuere sem nec, elementum ante.</p>
                                ...
                                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                    ...
                                    <p>Nullam et tellus ac ligula condimentum sodales. Aenean tincidunt viverra
                                        suscipit. Maecenas id molestie est, a commodo nisi. Quisque fringilla turpis nec
                                        elit eleifend vestibulum. Aliquam sed purus in odio ullamcorper congue
                                        consectetur in neque. Aenean sem ex, tempor et auctor sed, congue id neque. </p>
                                </div>
                    ...
                    <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 mb-5">
                        ...
                        <div class="tab-outline">
                            <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-outline-two" data-toggle="tab" href="#outline-two"
                                        role="tab" aria-controls="profile" aria-selected="false">Tab#2</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="tab-outline-three" data-toggle="tab" href="#outline-three"
                            ...
                            <div class="tab-content" id="myTabContent2">
                                ...
                                <div class="tab-pane fade" id="outline-two" role="tabpanel"
                                    ...
                                    <p>Nullam et tellus ac ligula condimentum sodales. Aenean tincidunt viverra
                                        ...
                                        elit eleifend vestibulum. Aliquam sed purus in odio ullamcorper congue
                                        consectetur in neque. Aenean sem ex, tempor et auctor sed, congue id neque. </p>
                                    <p>Fusce a eros pellentesque, ultricies urna nec, consectetur dolor. Maecenas eu
                                        sodales arcu. Fusce lobortis, libero ac cursus feugiat, nibh ex ultricies
                                        tortor, id dictum massa nisl ac nisi. </p>
                                </div>
                                <div class="tab-pane fade" id="outline-three" role="tabpanel"
                                    ...
                                    <p>Vivamus pellentesque vestibulum lectus vitae auctor. Maecenas eu sodales arcu.
                                        ...
                                        massa nisl ac nisi. Fusce a eros pellentesque, ultricies urna nec, consectetur
                                        dolor. Nam dapibus scelerisque risus, a commodo mi tempus eu.</p>
                                    <p>Maecenas eu sodales arcu. Fusce lobortis, libero ac cursus feugiat, nibh ex
                                        ultricies tortor, id dictum massa nisl ac nisi. Fusce a eros pellentesque,
                                        ultricies urna nec, consectetur dolor.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <ul class="nav nav-tabs " id="myTab4" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-outline-verti-tab" data-toggle="tab"
                                        href="#home-outline-vertical" role="tab" aria-controls="home"
                                        aria-selected="true">Tab#1</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-outline-verti-tab" data-toggle="tab"
                                        href="#profile-outline-vertical" role="tab" aria-controls="profile"
                                        aria-selected="false">Tab#2</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="contact-outline-verti-tab" data-toggle="tab"
                                        href="#contact-outline-vertical" role="tab" aria-controls="contact"
                            ...
                            <div class="tab-content" id="myTabContent4">
                                ...
                                <div class="tab-pane fade" id="profile-outline-vertical" role="tabpanel"
                                    ...
                                    <p>Nullam et tellus ac ligula condimentum sodales. Aenean tincidunt viverra
                                        ...
                                        elit eleifend vestibulum. Aliquam sed purus in odio ullamcorper congue
                                        consectetur in neque. Aenean sem ex, tempor et auctor sed, congue id neque. </p>
                                    <p>Pellentesque quis rutrum lacus. Aenean gravida massa dolor, mattis viverra quam
                                        luctus sed. Nunc nunc enim, aliquet sit amet consectetur sed, rutrum feugiat
                                        dolor. In convallis augue sed augue tincidunt, sit amet volutpat sapien cursus.
                                        Sed neque dolor, vehicula sit amet orci et, dapibus tincidunt mauris. </p>
                                </div>
                                <div class="tab-pane fade" id="contact-outline-vertical" role="tabpanel"
                                    ...
                                    <p>Vivamus pellentesque vestibulum lectus vitae auctor. Maecenas eu sodales arcu.
                                        ...
                                        massa nisl ac nisi. Fusce a eros pellentesque, ultricies urna nec, consectetur
                                        dolor. Nam dapibus scelerisque risus, a commodo mi tempus eu.</p>
                                    <p>Aenean a malesuada libero, id consequat tellus. In in varius metus. Suspendisse
                                        cursus blandit ipsum, sit amet venenatis lacus finibus ut. Orci varius natoque
                                        penatibus et magnis dis parturient montes, nascetur ridiculus mus. Maecenas
                                        bibendum turpis sit amet odio scelerisque, sit amet maximus metus hendrerit.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 mb-5">
                        ...
                        <div class="simple-card">
                            <ul class="nav nav-tabs" id="myTab5" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="contact-tab-simple" data-toggle="tab" href="#contact-simple"
                                        role="tab" aria-controls="contact" aria-selected="false">Tab#3</a>
                                </li>
                            </ul>
                            <div class="tab-content" id="myTabContent5">
                                ...
                                <div class="tab-pane fade" id="profile-simple" role="tabpanel"
                                ...
                                <div class="tab-pane fade" id="contact-simple" role="tabpanel"
                    ...
                    <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 mb-5">
                        ...
                        <div class="simple-outline-card">
                            <ul class="nav nav-tabs" id="myTab6" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active border-left-0" id="home-tab-simple-outline"
                                        data-toggle="tab" href="#home-simple-outline" role="tab" aria-controls="home"
                                        aria-selected="true">Tab#1</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="pills-regular">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                    ...
                                    <p>Phasellus non ante gravida, ultricies neque a, fermentum leo. Etiam ornare enim
                                        arcu, at venenatis odio mollis quis. Mauris fermentum elementum ligula in
                                        efficitur. Aliquam id congue lorem. Proin consectetur feugiat enim ut luctus.
                                        Aliquam pellentesque ut tellus ultricies bibendum. In hac habitasse platea
                                        dictumst. Pellentesque sed justo aliquet, posuere sem nec, elementum ante.
                                        Vestibulum dui tortor, consectetur quis sagittis vitae, dapibus ut magna. Cras
                                        ante dui, tincidunt et turpis vel, suscipit viverra eros. Ut auctor augue
                                        feugiat hendrerit feugiat.</p>
                                </div>
