...
<head>
    ...
    <link href="../assets/vendor/bootstrap-colorpicker/%40claviska/jquery-minicolors/jquery.minicolors.css"
        rel="stylesheet">
</head>
...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h6 class="card-subtitle">Valid positions include bottom left, bottom right, top left,
                                    and top right.</h6>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <h6 class="help-block text-muted font-light">
                                                This field has a default value assigned to it, so it will never be
                                                empty.
                                            </h6>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" id="input-group" class="form-control demo"
                                                    value="#ff0000" />
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" id="more-input-group" class="form-control demo"
                                                    value="#ff0000" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="swatches2" class="form-control demo"
    ...
    <script src="../assets/vendor/bootstrap-colorpicker/%40claviska/jquery-minicolors/jquery.minicolors.min.js">
    </script>
    <script>
    $('.demo').each(function() {
        //
