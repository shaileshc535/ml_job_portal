                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="section-block">
                            ...
                            <p>The <a
                                    ...
                                    target="_blank">media object</a> helps build complex and repetitive components where
                                some media is positioned alongside content that doesn’t wrap around said media. Plus, it
                                does this with only two required classes thanks to flexbox.</p>
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="media">
                                    <img class="mr-3 user-avatar-lg rounded" src="../assets/images/avatar-2.jpg"
                                        alt="Generic placeholder image">
                                    <div class="media-body">
                                        ...
                                        <div class="media mt-3">
                                            <a class="pr-3" href="#">
                                                <img class="mr-2 user-avatar-lg rounded"
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="media">
                                    <img class="mr-3 user-avatar-lg rounded" src="../assets/images/avatar-4.jpg"
                                        alt="Generic placeholder image">
                                    <div class="media-body">
                                        ...
                                        <p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante
                                            ...
                                            turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia
                                            congue felis in faucibus.</p>
                                        <p>Donec sed odio dm sociis natoque penat lorem ippum dolor sait maettempus
                                            viverra turpis. Fusce condimentum nuncac nisi dis parturient montes,
                                            nascetur ridiculus mus.</p>
                                        <p>Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante
                                            solliciturus ondimentum nunc ac sit ametm nisi vulputate frinue felis in
                                            faucibus.</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="media">
                                    <img class="align-self-center user-avatar-lg mr-3 rounded"
                                        src="../assets/images/avatar-5.jpg" alt="Generic placeholder image">
                                    <div class="media-body">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="media">
                                    <img class="align-self-end mr-3 user-avatar-lg rounded"
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="media">
                                    <div class="media-body">
                                        <h5 class="mt-0 mb-1">Media object</h5> Cras sit amet nibh libero, in gravida
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <ul class="list-unstyled">
                                    <li class="media">
                                        <img class=" mr-3 user-avatar-lg rounded" src="../assets/images/avatar-3.jpg"
                                            alt="Generic placeholder image">
                                        <div class="media-body">
                                            <h5 class="mt-0 mb-1">List-based media object</h5> Cras sit amet nibh
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        ...
                        <div class="card card-fluid">
                            ...
                            <div class="card-body">
                                ...
                                <div class="user-avatar">
                                    <img src="../assets/images/avatar-3.jpg" alt="User Avatar"
                                        class="rounded-circle user-avatar-sm">
                                </div>
                                <div class="user-avatar">
                                    <img src="../assets/images/avatar-4.jpg" alt="User Avatar"
                                        class="rounded-circle user-avatar-xs">
                                </div>
                                <hr>
                        ...
                        <div class="card card-fluid">
                            ...
                            <div class="card-body text-center">
                                ...
                                <p class="skills">
                                    ...
                                    <a href="#" class="btn btn-xs btn-outline-secondary mt-1">php5</a>
                                    <a href="#" class="btn btn-xs btn-outline-secondary mt-1">css3</a>
                                    <a href="#" class="btn btn-xs btn-warning circle mt-1">3+</a>
                                </p>
                                <!-- /.skills -->
                                <p class="text-muted"> I make stunning and cool responsive web and app design which
                                    suitable for any project purpose for your business. </p>
                                <p>
