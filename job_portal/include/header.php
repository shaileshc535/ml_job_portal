...
<!-- Mirrored from eyecix.com/html/careerfy/index-six.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Mar 2021 06:40:30 GMT -->
...
<body>
    ...
    <div class="jobsearch-wrapper">
        ...
        <header class="header--style-2">
                                    ...
                                    <li class="has-dropdown" data-tooltip="tooltip" data-placement="left"
                                        ...
                                        <ul style="width:120px">
                                            <li>
                                                ...
                                                <a href="candidate-dashboard-profile-seting.php"><i
            ...
            <!--====== Nav 2 ======-->
            <nav class="secondary-nav-w
    
    rapper" style="padding:0px;top-margin:60px;">
                <div class="container">
                                ...
                                <div class="menu-init" id="navigation2">
                                    ...
                                    <div class="ah-lg-mode">
                                        ...
                                        <ul class="ah-list ah-list--design2 ah-list--link-color-white"
                                            ...
                                            <li>
                                                <a href="shop-side-version-2.html">SHOP</a><span
                                            ...
                                            <li class="has-dropdown" style="color:black">
                                                ...
                                                <ul style="width:170px">
                                                    <li class="has-dropdown has-dropdown--ul-left-100">
                                                        ...
                                                        <a href="job-listings.php">Job Listing<i
                                                                class="fas fa-angle-down i-state-right u-s-m-l-6"></i></a>
                                                        <a href="employer-list.php?p=1">Employer<i
                                                                class="fas fa-angle-down i-state-right u-s-m-l-6"></i></a>
                                                        <a href="candidate-listings.php">Candidates<i
                                                                class="fas fa-angle-down i-state-right u-s-m-l-6"></i></a>
