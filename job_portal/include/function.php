        ...
        <div class="careerfy-joblisting-classic-wrap">
            ...
            <div class="careerfy-joblisting-text">
                <div class="careerfy-list-option">
                    ...
                    <h2>
                        <a href="job-detail-two.php?id=<?php echo $row['id'] ?>"><?php echo $row['jobtitle']; ?></a>
                        <span>Featured</span>
                    </h2>
                    <ul>
                        <li><a href="#">@<?php echo $row['company']; ?></a></li>
                        <li><i
                                class="careerfy-icon careerfy-maps-and-flags"></i><?php echo $row['state'] . "," . $row['city']; ?>
                        </li>
                ...
                <div class="careerfy-job-userlist">
                    <a href="job-detail-two.php?id=<?php echo $row['id'] ?>" class="careerfy-option-btn">Freelance</a>
