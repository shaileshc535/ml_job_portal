                            ...
                            <div class="col-lg-6 col-md-8 u-s-m-b-30">
                                <div class="l-f-o">
                                    <div class="l-f-o__pad-box">
                                        ...
                                        <span class="gl-text u-s-m-b-30">If you have an account with us, please log
                                            in.</span>
                                        <form class="l-f-o__form" method="post">
                                            ...
                                            <div class="u-s-m-b-30">
                                                ...
                                                <input class="input-text input-text--primary-style form-control" type="email"
                                                    id="login-email"  name="email" placeholder="Enter E-mail">
                                            </div>
                                            <div class="u-s-m-b-30">
                                            ...
                                            <button class="btn btn-sm btn-primary btn--e-transparent-brand-b-2" name="submit" value="submit" type="submit" >SUBMIT</button></div>
                                                <div class="u-s-m-b-30">

                                                    <a class="gl-link btn btn-lg btn-danger" href="lost-password.php">Lost Your Password?</a>
                                                </div>
                                            </div>
                                            <div class="u-s-m-b-30">
