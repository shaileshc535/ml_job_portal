...
document.getElementById('student_form').addEventListener('click',
function(){
    document.querySelector('.bg-student-form').style.display = "flex";
})

document.getElementById('close_student').addEventListener('click',
function(){
    document.querySelector('.bg-student-form').style.display = "none";
})
// --------------Architect Form Popup----------------------///

document.getElementById('arch_form').addEventListener('click',
function(){
    document.querySelector('.bg-architect-form').style.display = "flex";
})

document.getElementById('close_architect').addEventListener('click',
function(){
    document.querySelector('.bg-architect-form').style.display = "none";
})
// --------------Distributort Form Popup----------------------///

document.getElementById('distri_form').addEventListener('click',
function(){
    document.querySelector('.bg-distributor-form').style.display = "flex";
})

document.getElementById('close_distributor').addEventListener('click',
function(){
    document.querySelector('.bg-distributor-form').style.display = "none";
})
// --------------BRAND Form Popup----------------------///

document.getElementById('brand_form').addEventListener('click',
function(){
    document.querySelector('.bg-brand-form').style.display = "flex";
})

document.getElementById('close_brand').addEventListener('click',
function(){
    document.querySelector('.bg-brand-form').style.display = "none";
})
// --------------Contractor Form Popup----------------------///

document.getElementById('contract_form').addEventListener('click',
function(){
    document.querySelector('.bg-contractor-form').style.display = "flex";
})

document.getElementById('close_contractor').addEventListener('click',
function(){
    document.querySelector('.bg-contractor-form').style.display = "none";
})
// --------------Individual Form Popup----------------------///

document.getElementById('individual_form').addEventListener('click',
function(){
    document.querySelector('.bg-individual-form').style.display = "flex";
})

document.getElementById('close_individual').addEventListener('click',
function(){
    document.querySelector('.bg-individual-form').style.display = "none";
})
// --------------sign_up POPUP----------------------///
...
document.onkeydown = function(event) {
 ...
 // Target each keypress and update the input screen
  ...
  document.getElementById('calculate').addEventListener('click',function(){
    document.querySelector('.bg-calc').style.display = "flex";
  })
  document.getElementById('close').addEventListener('click',function(){
    document.querySelector('.bg-calc').style.display = "none";
  })
  ...
  function like_count(){
    if (typeof(Storage) !== "undefined") {
      ...
      document.getElementById("like_count").innerHTML = "Total Likes :" + localStorage.clickcount;
    } else {
      document.getElementById("like_count").innerHTML = "Sorry, your browser does not support web storage...";
    }
  }
...
document.getElementById('student_form').addEventListener('click',
function(){
    document.querySelectorAll('bg-search-form').style.display = "flex";
})

document.getElementById('close_form').addEventListener('click',
function(){
    document.querySelectorAll('bg-search-form').style.display = "none";
})
...
document.getElementById('unit_calculator').addEventListener('click',function(){
  document.querySelector('.bg-unit_calc').style.display = "flex";
})
document.getElementById('close_unit_calc').addEventListener('click',function(){
  document.querySelector('.bg-unit_calc').style.display = "none";
})
